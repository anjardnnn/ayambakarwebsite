...
<section id="home-section" class="hero">
    ...
    <div class="slider-item" style="background-image: url(<?php echo get_theme_uri('images/ayambakarbg.jpg'); ?>);">
        <div class="overlay"></div>
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">

          <div class="col-md-12 ftco-animate text-center">
            <h1 class="mb-2">Ayam Bakar</h1>
            <h2 class="subheading mb-4">Menjual Paket Nasi Ayam Bakar, Ayam Kremes, Ikan Bakar dll</h2>
    ...
    <audio src="<?php echo base_url('assets/audio/Charlie Puth - Marvin Gaye ft. Meghan Trainor [Official Video].mp3');?>" 
      autoplay='autoplay' hidden='hidden'></audio>


    <div class="slider-item" style="background-image: url(<?php echo get_theme_uri('images/nilabakarbg.jpg'); ?>);">
        <div class="overlay"></div>
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">

          <div class="col-sm-12 ftco-animate text-center">
            <h1 class="mb-2">Kualitas Terbaik</h1>
            <h2 class="subheading mb-4">Menerima Pesanan untuk Acara-Acara </h2>
            <p><a href="#products" class="btn btn-info">Belanja Sekarang</a></p>
          </div>
...
<section class="ftco-section" id="products">
  ...
  <section class="ftco-section img" style="background-image: url(<?php echo get_theme_uri('images/ayambakarbg.jpg'); ?>);">
  <div class="container">
