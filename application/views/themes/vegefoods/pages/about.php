...
?>
<div class="hero-wrap hero-bread" style="background-image: url('<?php echo get_theme_uri('images/ayambakarbg.jpg'); ?>');">
    <div class="container">
  ...
  <main id="main">
    <iframe width="560" height="315" src="<?php echo base_url('assets/video/Avatar_ The Last Airbender.mp4');?>" 
    frameborder="0" allowfullscreen muted="" autoplay='autoplay' loop="true"></iframe>
      

  <section class="ftco-section ftco-no-pb ftco-no-pt bg-light">
          <div class="container">
              <div class="row">
                  <div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url(<?php echo get_theme_uri('images/kuci.jpg'); ?>);">
